    ...
    useEffect(() => {
      const fetchTanggapanById = async () => {
        try {
          ...
          const response = await axios.get(`${BACKEND_API_ENDPOINT}/get/${id}/tanggapan`, {
            headers: {
            ...
            <div key={item.id} className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p>{item.user.name|| 'ID tidak tersedia'}</p>
                </div>
              </div>
            </div>
          ))}
